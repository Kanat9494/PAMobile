namespace PAMobile.ViewModels.OnlineDeposits;

internal class OnlineDepositViewModel : BaseViewModel
{
    internal OnlineDepositViewModel()
    {
    ...
    {
        get => _isCurrency;
        set => SetProperty(ref _isCurrency, value);
    }
    ...
    public int? LoanTerm
    {
        ...
        set
        {
            ...
            //else if (value < OnlineLoanConstants.ONLINE_LOAN_MIN_TERM)
            //    SetProperty(ref _loanTerm, OnlineLoanConstants.ONLINE_LOAN_MIN_TERM);
            else
    ...
    private async Task OnSendOnlineLoanDatas()
    {
        ...
        if ((CurrentOnlineLoan.LoanAmount == 0) || CurrentOnlineLoan.LoanTerm == 0 || CurrentOnlineLoan.FrontPassportData == null
            ...
            CurrentOnlineLoan.LoanTerm == null || CurrentOnlineLoan.WhatsAppNumber == null
            )
        {
        ...
        {
            await Shell.Current.DisplayAlert("", "Минимальная сумма депозита 1 000 сом, максимальная сумма депозита 200 000 сом", "Ок");
            IsLoading = false;
            return;
        }
