...
internal class DocumentsViewModel : BaseViewModel
{
    ...
    {
        GetPublicOffer = new AsyncRelayCommand(OnGetPublicOffer);
        GetLoanDocs = new AsyncRelayCommand(OnGetLoanDocs);
        GetDepositDocs = new AsyncRelayCommand(OnGetDepositDocs);
    ...
    public ICommand GetPublicOffer { get; }
    public ICommand GetLoanDocs { get; }
    public ICommand GetDepositDocs { get; }
    ...
    async Task OnGetLoanDocs()
    {
        await Shell.Current.GoToAsync(nameof(LoanDigitalDocsPage));
    }
    async Task OnGetDepositDocs()
    {
        await Shell.Current.GoToAsync("DepositElectronicDocumentsPage");
    }
}
